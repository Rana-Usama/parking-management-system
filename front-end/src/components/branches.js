                    ...
                    {branches.map((bran, i) => (
                      <tr className="row100">
                        ...
                        >
                          <input
                            onChange={(text) =>
                              this.handleCity(text, bran.branchID)
                            }
                            value={bran.cityName}
                            style={{
                              height: 30,
                        ...
                        >
                          <input
                            onChange={(text) =>
                              this.handleBranch(text, bran.branchID)
                            }
                        ...
                        <Button
                          onClick={() => this.handleUpdateBranch(bran)}
                          style={{
                            width: 70,
                            marginLeft: 10,
                        ...
                        <Button
                          onClick={() => this.handleDeleteBranch(bran.branchID)}
                          style={{
                            width: 70,
                            marginLeft: 10,
                            marginRight: -10,
